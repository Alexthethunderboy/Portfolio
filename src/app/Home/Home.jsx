  ...
  return (
    <div className={styles.homediv}>
      <div className="text-white p-5 h-[80%] flex flex-col gap-6 justify-center items-center text-center">
        ...
        initial={{ y: '-100vh' }}
        animate={{ y: 0}}
        transition={{ delay: 4, duration: 4, type: 'spring', stiffness: 120}}
        >Welcome</motion.h1>
        <motion.p className="text-3xl md:text-5xl font-bold"
          initial={{ x: '100vw' }}
          animate={{ x: 0}}
          transition={{ delay: 5, duration: 4, type: 'spring'}}
        >
        ...
        <motion.a href="/myResume.pdf" download='KelechiugohResume.pdf'
          initial={{ y: '100vh' }}
          animate={{ y: 0}}
          transition={{ delay: 7, duration: 4, type: 'spring', stiffness: 200}}
        >
