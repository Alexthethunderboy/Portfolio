  ...
  return (
    <div className="mb-20 mt-5 md:mt-20">
      ...
      <div className="flex flex-col md:flex-row gap-5 mt-5 md:gap-10 md:mt-10 text-white text-bold text-7xl md:items-center">
        ...
        >
          <Link href="https://www.linkedin.com/in/thunderboy" target="_blank">
            <FaLinkedin />
          </Link>
        </motion.div>
        <motion.div
        ...
        >
          <Link href="https://github.com/Alexthethunderboy" target="_blank">
            <FaGithub />
          </Link>
        </motion.div>
        <motion.div
        ...
        >
          <Link href="mailto:alexthegreatdeveloper@gmail.com " target="_blank">
            <IoMdMail />
          </Link>
          <div className="flex items-center gap-1 rounded bg-gray-900 text-gray-500 text-sm p-2 ">
            <input
              ...
              className="outline-none  bg-gray-900 md:w-60"
            />
